<template>
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-2">
                    <div class="d-flex flex-column align-items-start justify-content-center shadow-sm">
                        <img :src="eventTypeImage" class="w-100">
                        <span class="w-100 text-center py-2 attribute-label font-weight-bold">{{ eventTypeDescription }}</span>
                    </div>
                </div>
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center justify-content-center border py-1">
                                    ...
                                    <div class="d-inline-flex mx-2 align-items-center" title="Vreme početka">
                                        <i class="mdi mdi-clock-alert-outline mr-1 attribute-label font-16"></i>
                        ...
                        <div class="col-lg-2">
                            <div class="d-flex flex-column">
                                ...
                                <b-form-select v-model="form.eventStatus" :options="statusOptions"></b-form-select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="training != null && training.files.length > 0 && training.files[0].filelink != ''" class="d-flex flex-wrap justify-content-start align-items-center">
                        ...
                        <file-item
                            ...
                            :filelink="file.filelink" :key="index" :fontsize="14"
                            class="mr-2"></file-item>
                    </div>
                    <div v-else>
            ...
            <div class="d-flex flex-column mt-2">
                <label class="attribute-label font-italic">Organizator</label>
                <div id="trainingDescriptionHtml" class="p-2 overflow-auto border" style="height: 15vh"></div>
            </div>
            ...
            <div v-if="program_id == 0" class="d-flex flex-column mt-4">
                ...
                <b-pagination
                    ...
                    :per-page="10"
                    aria-controls="attTable" align="right"
                ></b-pagination>
            </div>

            <div class="d-flex flex-wrap align-items-center justify-content-center mt-4">
                <b-button v-if="program_id == 0" variant="primary" size="sm" class="m-1" @click="onOk">Prihvati</b-button>
                <b-button variant="outline-primary" size="sm" class="m-1" @click="onCancel">Zatvori</b-button>
            </div>
...
export default {
    ...
    methods: {
        async getData() {
            await axios.get(`/trainings/get/${this.event_id}`)
            .then(response => {
        ...
        async onOk() {
            ...
            await axios.post(`/trainings/${this.event_id}`, formData)
            .then(response => {
                console.log(response.data);

          ...
          <div class="card-body row" style="padding: 30px 24px">
            <div class="col-lg-4">
              <div class="d-flex justify-content-center align-items-center h-100 w-100">
                <div
                  class="card m-2 shadow-sm text-center"
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                >
                  ...
                  >
                    {{ getCurrencyValue(analysis.prihod) }}
                  </p>
                </div>
              </div>
              <div class="col-lg-6">
                ...
                >
                  ...
                  <p
                    ...
                    style="font-family: 'Roboto Light'"
                  >
                    {{ getCurrencyValue(analysis.izvoz) }}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-6">
                ...
                >
                  ...
                  <p
                    ...
                    style="font-family: 'Roboto Light'"
                  >
                    {{ getCurrencyValue(analysis.porez) }}
                  </p>
                </div>
              </div>
              <div class="col-lg-6">
                ...
                >
                  ...
                  <p
                    ...
                    style="font-family: 'Roboto Light'"
                  >
                    {{ getCurrencyValue(analysis.investicije) }}
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    async getData() {
      await axios.get("/analytics/getProfileStatisticsSummary").then((response) => {

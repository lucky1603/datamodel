  ...
  <div class="card h-100 w-100">
    ...
    <div class="card-body">
      ...
      >
        ...
        />
        <div class="card-body h-100 p-1" style="display: flex; justify-content: center; flex-wrap: wrap">
            <tile-item
                class="m-1"
                :id="1"
                role="button"
...
export default {
  ...
  methods: {
    ...
    selectEventType(id) {
      this.form.training_type = id;
      Dispecer.$emit("tile-selected", this.form.training_type);
    ...
    async getData() {
      await axios.get(`/trainings/fetch/${this.event_id}`).then((response) => {
  ...
  data() {
    return {
      ...
      programTypes: [
        { value: 0, text: "Izaberite tip programa ..." },
        { value: 2, text: "Raising Starts" },
        { value: 5, text: "Incubation BITF" },
        { value: 6, text: "Rastuće kompanije" },
      ],
    };
  },
  async mounted() {

    ...
    <b-form v-if="show_header" id="filterForm" inline class="w-100 bg-light">
      <b-row id="toolbar" class="row w-100">
        <b-col xl="1" lg="1" class="pt-1">
          <span class="m-2 position-relative" style="top: 12px">{{
            _("gui.profile_list_filter")
          }}</span>
        </b-col>
        <b-col
          xl="2"
        ...
        >
          <b-input-group class="w-100 m-2 mt-3 mt-sm-3 mt-lg-2" size="sm">
            <b-form-input
              ...
              type="search"
              id="searchName"
              :placeholder="_('gui.profile_list_filter_name')"
              @update="onSubmit"
            ></b-form-input>
            <template #append>
...
export default {
  ...
  methods: {
    async getData() {
      ...
      await axios.post(this.source, formData).then((response) => {
  ...
  data() {
    return {
      ...
      states: [
        ...
        { value: 2, text: window.i18n.gui.profile_list_state_active },
        { value: 3, text: window.i18n.gui.profile_list_state_alumni },
        { value: 4, text: window.i18n.gui.profile_list_state_rejected },
      ],
      ntps: [
      ...
      types: [
        { value: -1, text: window.i18n.gui.profile_list_type_choice },
        { value: 0, text:  window.i18n.gui.profile_list_type_startup },
        { value: 1, text:  window.i18n.gui.profile_list_type_company },
      ],
    };
  },
};

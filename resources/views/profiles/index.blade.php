    ...
    @foreach($profiles as $profile)
        @if($loop->iteration % 4 == 1)
            <div class="row" style="height: 30%">
                ...
                <div class="col-md-3 mt-1 mb-1 h-100 p-2">
                    <profile-item
                        @if($data['profile_logo'] != null)
                            logo="{{ $data['profile_logo']['filelink'] }}"
                        @endif
                        title="{{ $data['name'] }}"
                        @if($profile->getActiveProgram() != null)
                            :type="{{ $profile->getActiveProgram()->getValue('program_type') }}"
                        @endif
                        :id="{{ $profile->getId() }}"
                        :status="{{ $status }}"
...
{{--                                            @case(5)--}}
{{--                                                <img src="/images/custom/inkubacija.png"  style="width: 100px">--}}
{{--                                                @break--}}
{{--                                            @case(2)--}}
{{--                                                <img src="/images/custom/raisingstarts.png" class="bg-primary rounded-circle" style="width: 100px">--}}
{{--                                                @break--}}
{{--                                            @default--}}
...
{{--                                    @endif--}}
{{--                                    <div >--}}
{{--                                        <span class="text-center font-18">{{ $data['name'] }}</span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}

...
<div class="form-group">
    <label for="{{ $model->getAttribute('product_description')->name }}">{{ $model->getAttribute('product_description')->label }}</label>
...
<div class="form-group">
    <label for="{{ $model->getAttribute('inovation_type')->name }}">{{ $model->getAttribute('inovation_type')->label }}</label>
...
<div class="form-group">
    <label for="{{ $model->getAttribute('inovativity')->name }}">{{ $model->getAttribute('inovativity')->label }}</label>
...
<div class="form-group">
    <label for="{{ $model->getAttribute('intelectual_property_protection')->name }}">{{ $model->getAttribute('intelectual_property_protection')->label }}</label>
...
<div class="form-group">
    <label for="{{ $model->getAttribute('mvp_testing')->name }}">{{ $model->getAttribute('mvp_testing')->label }}</label>

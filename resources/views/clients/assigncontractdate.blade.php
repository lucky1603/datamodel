...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h1 style="text-align: center;margin-bottom: 50px;margin-top:30px">Pozivanje klijenta '{{ $client->getData()['name'] }}' na potpis ugovora</h1>
            </div>
        </div>
        <form method="POST" enctype="multipart/form-data" action="{{ route('clients.assignedContractDate', $client->getId()) }}">
            @csrf
            <div class="form-group row">
                <label for="meeting_date" class="col-sm-2 col-form-label">Datum potpisa ugovora</label>
                <div class="col-sm-10">
